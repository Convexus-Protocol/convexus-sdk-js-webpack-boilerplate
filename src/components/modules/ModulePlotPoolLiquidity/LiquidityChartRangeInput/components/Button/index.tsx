...
export const ButtonLight = styled(BaseButton)<{redesignFlag?: boolean}>`
    background-color: ${({theme, redesignFlag}) =>
        redesignFlag ? theme.accentActionSoft : theme.deprecated_primary5};
    color: ${({theme, redesignFlag}) =>
        redesignFlag ? theme.accentAction : theme.deprecated_primaryText1};
        ...
        box-shadow: 0 0 0 1pt
            ${({theme, disabled, redesignFlag}) =>
                ...
                (redesignFlag
                    ...
                    : darken(0.03, theme.deprecated_primary5))};
    ...
    &:active {
        box-shadow: 0 0 0 1pt
            ${({theme, disabled, redesignFlag}) =>
                ...
                (redesignFlag
                    ? theme.accentActionSoft
                    : darken(0.05, theme.deprecated_primary5))};
        background-color: ${({theme, disabled, redesignFlag}) =>
            !disabled &&
            (redesignFlag
                ? theme.accentActionSoft
    ...
    :disabled {
        ...
        :hover {
            cursor: auto;
            background-color: ${({theme, redesignFlag}) =>
                redesignFlag ? 'transparent' : theme.deprecated_primary5};
            box-shadow: none;
            border: 1px solid transparent;
            outline: none;
        }
...
export const ButtonGray = styled(BaseButton)`
    ...
    &:hover {
        background-color: ${({theme, disabled}) =>
            !disabled && darken(0.05, '#2C2F36')};
    }
    &:active {
        background-color: ${({theme, disabled}) =>
            !disabled && darken(0.1, '#2C2F36')};
    }
`;
...
export const ButtonYellow = styled(BaseButton)<{redesignFlag?: boolean}>`
    ...
    color: ${({theme, redesignFlag}) =>
        redesignFlag ? theme.accentWarning : 'white'};
    &:focus {
        box-shadow: ${({theme, redesignFlag}) =>
            !redesignFlag && `0 0 0 1pt ${theme.deprecated_yellow3}`};
        background-color: ${({theme, redesignFlag}) =>
            redesignFlag
                ? theme.accentWarningSoft
                : darken(0.05, theme.deprecated_yellow3)};
    }
    &:hover {
        background: ${({theme, redesignFlag}) =>
            redesignFlag && theme.stateOverlayHover};
        mix-blend-mode: ${({redesignFlag}) => redesignFlag && 'normal'};
        background-color: ${({theme, redesignFlag}) =>
            !redesignFlag && darken(0.05, theme.deprecated_yellow3)};
    }
    &:active {
        box-shadow: ${({theme, redesignFlag}) =>
            !redesignFlag &&
            `0 0 0 1pt ${darken(0.1, theme.deprecated_yellow3)}`};
        background-color: ${({theme, redesignFlag}) =>
            redesignFlag
                ? theme.accentWarningSoft
...
const ButtonErrorStyle = styled(BaseButton)`
    ...
    &:focus {
        box-shadow: 0 0 0 1pt
            ${({theme}) => darken(0.05, theme.deprecated_red1)};
